...
keymap('n', '<leader>Db', ':bd<cr>', { desc = '[B]uffer' })
...
keymap({ 'n', 'v' }, '<S-Up>', 'gk', { noremap = true, desc = 'Move up by display line' })
keymap({ 'n', 'v' }, '<S-Down>', 'gj', { noremap = true, desc = 'Move down by display line' })
...
vim.keymap.set('n', '<leader>ww', '<C-w>c', { desc = 'Close pane' })
...
keymap('v', '<leader>*', '"sy/\\V<C-R>s<CR>``cgn', { desc = 'Multi-Cursor Edit' })
